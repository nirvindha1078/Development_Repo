...
namespace Product_Inventory_Management_API.Services
{
    public class ProductService : IProductService
    {
        ...
        public void CreateProduct(Product product) => _productRepository.AddProduct(product);

        public void UpdateProduct(int id, Product product) => _productRepository.UpdateProduct(id, product);

        public void DeleteProduct(int id) => _productRepository.DeleteProduct(id);

        public void InsertInitialData() => _productRepository.InsertInitialData();
    }
}
